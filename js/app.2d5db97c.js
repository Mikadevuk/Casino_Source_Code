                    ...
                    F = (0, a._)(
                        ...
                        [
                            (0, a._)("div", { class: "row tf-12 tfcdb tfw-7 1wtj0ep pbt-18" }, [
                                ...
                                (0, a._)("div", { class: "col-6 pdl5", onclick: "window.location.href='https://telegram.me/fastwinn.trade'" }, [(0, a._)("div", { class: "icard" }, [(0, a._)("img", { src: D })])]),
                            ]),
                        ],
                        -1
                    ),
                ...
                var X = n(9669),
                    ...
                    _ = {
                        ...
                        beforeCreate: function () {
                            q()
                                .get("https://fastwinn.trade/9987/src/api/bet.php?action=verifytoken&user=" + localStorage.getItem("username"), {
                        ...
                        methods: {
                            ...
                            getUserdetails() {
                                (this.username = localStorage.getItem("username")),
                                    q()
                                        .get("https://fastwinn.trade/9987/src/api/bet.php?action=getuserinfo&user=" + this.username, { headers: { Authorization: `Bearer ${this.secretKey}` } })
                                        .then((A) => {
